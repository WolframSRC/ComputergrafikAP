...
public:
    ...
    void genVBO(GLfloat* vbo, unsigned int meshId = 0.0f, bool normals = true, bool texcoords = true) const;
    ...
    unsigned int lengthOfVBO(unsigned int meshId = 0.0f, bool normals = true, bool texcoords = true) const;
